...
navegador.find_element("xpath", "/html/body/div[1]/div/div/div/div[2]/div[1]/div/div/div[3]/div").click()
...
nome_arquivo = f"{nome_pasta}/navegantes_cc_dia_corte_{data_atual}.png"
...
caminho_imagem = f"evidencias_baixa_remessa/navegantes_cc_dia_corte_{data_hoje}.png"
...
mail.Body = (
    "Olá,\n\n"
    "Segue em anexo a evidência da data de corte - Prefeitura de Navegantes, Cartão Consignado.\n\n"
    "Atenciosamente."
)
