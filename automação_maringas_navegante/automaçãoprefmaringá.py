...
navegador.find_element("xpath", "/html/body/div[1]/div/div/div/div[2]/div[1]/div/div/div[5]/div").click()
...
nome_arquivo = f"{nome_pasta}/pref_maringá_dia_corte_{data_atual}.png"
...
caminho_imagem = f"evidencias_baixa_remessa/pref_maringá_dia_corte_{data_hoje}.png"
...
mail.Subject = f"Evidência do dia - Prefeitura de Maringá {data_hoje}."
mail.Body = (
    "Olá,\n\n"
    "Segue em anexo a evidência da data de corte - Prefeitura de Maringá.\n\n"
    "Atenciosamente."
)
