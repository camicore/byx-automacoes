...
navegador.find_element("xpath", "/html/body/div[1]/div/div/div/div[2]/div[1]/div/div/div[1]/div").click()
...
nome_arquivo = f"{nome_pasta}/maringa_prev_dia_corte_{data_atual}.png"
...
caminho_imagem = f"evidencias_baixa_remessa/maringa_prev_dia_corte_{data_hoje}.png"
...
mail.Subject = f"Evidência do dia - MARINGÁ PREV {data_hoje}"
mail.Body = (
    "Olá,\n\n"
    "Segue em anexo a evidência da data de corte - (MARINGÁ PREV).\n\n"
    "Atenciosamente."
)
