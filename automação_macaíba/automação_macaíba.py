...
# Login Usuário
navegador.find_element("xpath", "/html/body/div[2]/div/div[1]/div[3]/div[2]/div[1]/form/div[1]/div[1]/input").send_keys(USER)

time.sleep(2)

# Usuário Senha
navegador.find_element("xpath", "/html/body/div[2]/div/div[1]/div[3]/div[2]/div[1]/form/div[1]/div[2]/input").send_keys(PWD)
time.sleep(2)
...
nome_arquivo = f"{nome_pasta}/Pref_Macaíba_dia_corte_{data_atual}.png"
...
caminho_imagem = f"evidencias_baixa_remessa/Pref_Macaíba_dia_corte_{data_hoje}.png"
...
mail.Subject = f"Evidência do dia - Prefeitura de Macaíba {data_hoje}."
mail.Body = (
    "Olá,\n\n"
    "Segue em anexo a evidência da data de corte - Prefeitura de Macaíba - RN.\n\n"
    "Atenciosamente."
)
