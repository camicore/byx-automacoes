...
# Login
navegador.find_element("xpath", "/html/body/div/div[1]/form/div[3]/div/div/div/div/div[1]/div/div[1]/div/input").send_keys("8495069644")

time.sleep(2)

# Senha
navegador.find_element("xpath", "/html/body/div/div[1]/form/div[3]/div/div/div/div/div[1]/div/div[2]/div/input").send_keys("kWsmgTvk")
time.sleep(2)
...
navegador.find_element("xpath", "/html/body/form/div[3]/div[2]/div[2]/div/div/div/div[1]/fieldset/div[1]/table/tbody/tr/td[2]/div/div/ul/li[3]").click()
time.sleep(2)
...
nome_arquivo = f"{nome_pasta}/Inst_de_Prev_de_Sorriso_dia_corte_{data_atual}.png"
...
caminho_imagem = f"evidencias_baixa_remessa/Inst_de_Prev_de_Sorriso_dia_corte_{data_hoje}.png"
...
mail.Subject = f"Evidência do dia - Inst. de Prev. de Sorriso - MT {data_hoje}."
mail.Body = (
    "Olá,\n\n"
    "Segue em anexo a evidência da data de corte - Inst. de Prev. de Sorriso - MT.\n\n"
    "Atenciosamente."
)
