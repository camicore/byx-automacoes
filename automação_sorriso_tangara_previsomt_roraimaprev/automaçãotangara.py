...
navegador.find_element("xpath", "/html/body/form/div[3]/div[2]/div[2]/div/div/div/div[1]/fieldset/div[1]/table/tbody/tr/td[2]/div/div/ul/li[2]").click()
time.sleep(2)
...
nome_arquivo = f"{nome_pasta}/pref_tangara_dia_corte_{data_atual}.png"
...
caminho_imagem = f"evidencias_baixa_remessa/pref_tangara_dia_corte_{data_hoje}.png"
...
mail.Subject = f"Evidência do dia - Prefeitura de Tangará da Serra {data_hoje}."
mail.Body = (
    "Olá,\n\n"
    "Segue em anexo a evidência da data de corte - Prefeitura de Tangará da Serra.\n\n"
    "Atenciosamente."
)
