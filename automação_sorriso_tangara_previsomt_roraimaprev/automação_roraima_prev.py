...
nome_arquivo = f"{nome_pasta}/Roraima_prev_dia_corte_{data_atual}.png"
...
caminho_imagem = f"evidencias_baixa_remessa/Roraima_prev_dia_corte_{data_hoje}.png"
...
mail.Subject = f"Evidência do dia - Roraima Prev {data_hoje}."
mail.Body = (
    "Olá,\n\n"
    "Segue em anexo a evidência da data de corte - Roraima Prev.\n\n"
    "Atenciosamente."
)
